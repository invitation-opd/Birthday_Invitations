...
<head>
    ...
    <style>
        /* ========================================================== */
        /* CSS STYLES (UPDATED FOR SIZE & ENGLISH) */
        /* ========================================================== */
        ...
        /* ---------------------------------------------------------- */
        /* Background Animasi (Same as before) */
        /* ---------------------------------------------------------- */
        .particle-bg {
            position: fixed;
            top: 0;
        ...
        /* Border Decorations (Corner elements) */
        /* ... (CSS for border decorations remains the same) ... */
        .invitation-frame::before, .invitation-frame::after {
            content: ''; position: absolute; background: var(--color-gold); width: 30px; height: 4px;
        }
        .invitation-frame::before { top: -4px; left: -4px; }
        .invitation-frame::after { top: -4px; right: -4px; }

        .invitation-frame .corner-deco {
            position: absolute; width: 50px; height: 50px; border: 2px solid var(--color-gold); border-radius: 20px;
        }
        ...
        /* Lita and 30 are now much larger and similar size */
        .title-name {
        ...
        .title-age {
            font-size: 8em; /* NEW: SAME LARGE SIZE AS NAME */
            color: white;
            line-height: 0.8;
            margin-top: -30px; /* Bring closer */
            font-weight: 700;
        }
        ...
        /* Removed dashed borders from countdown */
        #countdown {
            margin: 30px 0 20px;
            padding: 15px 0;
        }
        ...
        @media (max-width: 600px) {
            ...
            .invitation-frame { padding: 30px 20px; }
        ...
        @media (max-width: 400px) {
            ...
            .invitation-frame { padding: 25px 15px; }
        }
    </style>
</head>
<body>
    ...
    <div class="container">
        <div class="invitation-frame">
            ...
            <div class="location-section">
                ...
                <a href="http://googleusercontent.com/maps.google.com/6" target="_blank" class="cta-button">
            ...
            <div class="rsvp-section">
                ...
                <button class="cta-button" onclick="alert('Thank you! Your RSVP has been received.');">I Will Attend</button>
                <button class="cta-button" style="background: white; color: black; margin-left: 10px;" onclick="alert('We will miss you!');">Regretfully Decline</button>
            </div>
    ...
    <script>
        // ----------------------------------------------------------
        // 1. Countdown Timer (Event date remains the same)
        // ----------------------------------------------------------
        ...
        // ----------------------------------------------------------
        // 2. Background Animation (Same as before)
        // ----------------------------------------------------------
